...
#define FILTER_FRIENDLY_NAME        L"FileBlocker NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{1638a4d8-de85-4fff-b1b7-2207e7ec6283}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"FileBlocker"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\FileBlocker"
#define NTDEVICE_STRING             L"\\Device\\FileBlocker"
...
DRIVER_DISPATCH FileBlockerDispatch;

DRIVER_DISPATCH FileBlockerDeviceIoControl;
